...
from database.base import async_session_maker, get_async_session, get_async_sessionmaker
...
class UnitOfWork(UnitOfWorkBase):
    def __init__(self, session_factory: Annotated[async_sessionmaker, Depends(get_async_sessionmaker)]) -> None:
        """
