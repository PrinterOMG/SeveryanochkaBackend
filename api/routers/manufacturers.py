...
from api.schemas.manufacturer import (
    ManufacturerRead,
    ManufacturerCreate,
    ManufacturerUpdate,
)
...
async def get_manufacturer(
    manufacturer_service: ManufacturerServiceDep, manufacturer_id: UUID
):
...
async def create_manufacturer(
    manufacturer_service: ManufacturerServiceDep, new_manufacturer: ManufacturerCreate
):
    return await manufacturer_service.create(new_manufacturer)


@router.put('/{manufacturer_id}', dependencies=[Depends(current_user_id_admin)])
